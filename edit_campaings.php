...
<?php
    ...
    if (isset($_POST['SAVE'])) {
        ...
        $arr_data = array(
			...
			'Promo_sale' => $_POST['insurance_promo'],
        ...
        $db->update('insurance_campaign_detail',$arr_data,$arr_con);
			...
			if($_FILES['campaign_detail_file']['size'] > 0)
			{
				...
				$query_del = "delete from insurance_upload where campaign_id=".$_GET['id'];
				mysql_query($query_del) or die('Error, query failed');
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" value="<?=$dd['campaign_car_age']?>" name="campaign_car_age" >
