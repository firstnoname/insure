...
<div class="profile-user-info profile-user-info-striped col-sm-12">
      ...
      <div class="profile-info-row">
			 <div class="profile-info-name">รหัสตัวแทน</div>
				<div class="profile-info-value">
				 <div  class="col-md-5">
          <input class="form-control input-mask-product" id="txtnumber"  type="text" value="<? echo $row_request['insure_req_deler'];?>">
				</div>
			 </div>
			</div>
      ...
      <div class="profile-info-row" id="div_address">
            ...
            <input class="form-control input-mask-product" id="txtnumber" type="text" value="<? echo $row_request['insure_req_code'];?>">
					</div>
				   </div>
			</div>
        ...
        <tr>
         ...
         <div class="checkbox">
					<label>
						<input name="form-field-checkbox" class="ace ace-checkbox-2" name="task_name[]" type="checkbox">
          ...
          <?php }; ?>
					...
					<div class="profile-info-value">
					 <div class="col-md-9" >
            <textarea class="form-control limited" id="remark" maxlength="250"><?echo $row_request['insure_req_detail_org'];?></textarea>
					</div>
				   </div>
			</div>
                             <div class="profile-info-row" >
					...
					<div class="profile-info-value">
					 <div class="col-md-9" >
              <textarea class="form-control limited" id="remark" maxlength="250"><?echo $row_request['insure_req_detail_new'];?></textarea>
					</div>
				   </div>
			</div>
                       	<div class="profile-info-row">
            ...
            <span class="input-icon input-icon-right">
              <select name="company_id"  id="company_id" data-placeholder="Choose a State...">
               ...
               <option value="2">เพิ่ม</option>
              </select>
            </span>
            <span class="input-icon input-icon-right">
                <input id="form-field-icon-2" type="text" value="<?echo $row_request['insure_req_exchange_rate'];?>" > บาท
            </span>
                ...
                <!-- /section:elements.form.input-icon -->
					...
					<div class="profile-info-value">
					 <div class="col-md-5" id="prices">
              <select name="seladdress"  id="seladdress" data-placeholder="Choose a State...">
                <option value="">เลือก</option>
                <option value="1">ตามที่อยู่</option>
                <option value="2">ผ่านตัวแทน</option>
      ...
      <div class="profile-info-row"  id="div_other">
					...
					<div class="profile-info-value">
					 <div class="col-md-9" >
            <textarea class="form-control limited" id="remark" maxlength="250"><?echo $row_request['insure_req_doc_retrun_other'];?></textarea>
					</div>
				   </div>
			</div>
     ...
     <div class="profile-info-row" >
			<div class="profile-info-name">หมายเหตุ</div>
			 <div class="profile-info-value">
			  <div class="col-md-9" >
         <textarea class="form-control limited" id="remark" maxlength="250"><?echo $row_request['insure_req_remark'];?></textarea>
			  </div>
		   </div>
			</div>
</div>
			...
			<div class="profile-info-row col-sm-12">
		           ...
		           <button class="btn btn-success" type="button" id="btnsave">
					<i class="ace-icon glyphicon glyphicon-floppy-disk bigger-110"></i>
					บันทึกเอกสาร											</button>
				...
				$("#btnsave").click(function() {
					...
					if($('#chk2').is(':checked')){
						...
						$.ajax({
							...
							type: "post",
							data: {cus_id:cus_id,ve_id:ve_id,receipt_date:receipt_date,delivery_date:delivery_date,insure_num:insure_num,address:address,receipt_by:receipt_by,remark:remark,insure_act:insure_act,delivery_type:delivery_type,delivery_close:0,action:1} ,
