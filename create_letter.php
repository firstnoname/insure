					...
					<div class="page-content">
					  ...
					  <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="letter_name" placeholder="ชื่อ" class="col-xs-10 col-sm-5" name="letter_name"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> จดหมาย</label>
					...
					$('#btnSave').click(function() {
						///alert(1);
								 ...
								 $.ajax({
									url: "saveletter.php",
									type: "post",
									data: {name:name,detail:value,action:0} ,
