                ...
                <div class="main-content-inner">
                    ...
                    <div class="breadcrumbs" id="breadcrumbs">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">กำหนดรูปแบบ SMS</li>
                        </ul><!-- /.breadcrumb -->
								  	...
								  	<div ng-controller="vehicleCrtl">
																<div class="container">
																	...
																	<div class="row">
																		...
																		<a href="Create_SMS.php"role="button" class="btn btn-xs btn btn-info" ><i class="fa fa-circle-plus" aria-hidden="true"></i> เพิ่มรูปแบบ SMS</a>
...
<!--
                                            ...
                                            <td>{{data.sms_title}}</td>
																						<td>{{data.sms_detail}} </td>
																						<td class="text-center">
																							<a href="Edit_SMS.php?id={{data.sms_id}}" class="btn btn-xs btn-yellow">
...
<![endif]-->
		...
		<script>
		      getSearch('vehicleCrtl','getSMS.php',10);
		</script>
