					  ...
					  <div class="col-xs-12">
                                ...
                                <?php
                                    ...
                                    if (isset($_POST['SAVE'])) {
                                        ...
                                        $db->insert('insurance_Activity',$arr_data);
                                ...
                                <form class="form-horizontal" role="form" method="POST" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1" placeholder="ชื่อ" class="col-xs-10 col-sm-5" name="activity_name"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> ประเภท</label>
                       ...
                       <option value="CALL">โทรติดตาม</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-5"> แจ้งเตือนล่วงหน้า</label>
