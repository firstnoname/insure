						...
						<div class="page-header">
							<h1>
							 ...
							 <div class="row">
                                ...
                                <div class="col-sm-12" >
                                  <div class="profile-user-info profile-user-info-striped col-sm-12">
                                        ...
                                        <div class="input-group">
                                					<input class="form-control date-picker" id="receipt_date" value="<?php
                            								echo  date("d-m-Y");?>" type="text" data-date-format="dd-mm-yyyy" />
                                 ...
                                 <div class="profile-info-row">
                                			...
                                			<div class="profile-info-value">
                                			 <div class="col-md-5">
                                        <input class="form-control input-mask-product" id="txtnumber"  type="text">
                                			</div>
                                			</div>
                                			...
                                			<div class="profile-info-value">
                                			 <div  class="col-md-5">
                                        <input class="form-control input-mask-product" id="insure_req_deler"  type="text">
                                			</div>
                                		   </div>
                                	</div>
                                    ...
                                    <div class="profile-info-row" id="div_address">
                                           ...
                                           <input class="form-control input-mask-product" id="insure_req_code"  type="text">
                                         </div>
                                		  </div>
                                	  </div>
                                ...
                                <div class="profile-info-value">
                                  <div class="col-md-9" >
                                    <textarea class="form-control limited" id="insure_req_detail_org" maxlength="250"></textarea>
                                	</div>
                                </div>
                                </div>
                                ...
                                <div class="profile-info-value">
                                  <div class="col-md-9" >
                                    <textarea class="form-control limited" id="insure_req_detail_new" maxlength="250"></textarea>
                                	</div>
                                </div>
                                </div>
                                ...
                                <div class="profile-info-value">
                                  <div class="col-sm-9">
                                    ...
                                    <span class="input-icon input-icon-right">
                                      <select name="company_id" id="insure_req_exchange_rate_type" data-placeholder="Choose a State...">
                                    ...
                                    <span class="input-icon input-icon-right">
                                        <input id="insure_req_exchange_rate" type="text"  > บาท
                                    </span>
                                ...
                                <div class="profile-info-row" id="div_address">
                                  ...
                                  <div class="profile-info-row"  id="div_other">
                                		<div class="profile-info-name">ระบุ</div>
                                			<div class="profile-info-value">
                                			 <div class="col-md-9" >
                                         <textarea class="form-control limited" id="insure_req_doc_retrun_other" maxlength="250"></textarea>
                                			  </div>
                                		  </div>
                                	</div>
                                  ...
                                  <div class="profile-info-row" >
                                	 <div class="profile-info-name">หมายเหตุ</div>
                                		<div class="profile-info-value">
                                			<div class="col-md-9" >
                                         <textarea class="form-control limited" name="insure_req_remark" id="insure_req_remark" maxlength="250"></textarea>
                                			</div>
                                		</div>
                                	</div>
                                </div>
