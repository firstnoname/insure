<?php
	...
	$aColumns = array('vehicle_chassis', 'cus_name', 'cus_surename', 'relates_type', 'vehicle_brand','regis_date' );  
	
	/* กำหนด primary key ให้กับคอลัมน์ */
	$sIndexColumn = "vehicle_chassis";
	
	/* ชื่อตาราง */
	$sTable = "insurance_relationship_view";
