         ...
         <tr>
           ...
           <td>
             <tr height="35">
              ...
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_7;?>> 7. ยกเลิกกรมธรรม์</td>
             </tr>
             <tr height="35">
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_2;?>> 2. ที่อยู่ผู้เอาประกัน</td>
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_8;?>> 8. จ่ายเช็คในนาม</td>
             </tr>
             <tr height="35">
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_3;?>> 3. รายการรถยนต์ที่เอาประกัน</td>
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_9;?>> 9. รหัสรถ</td>
             </tr>
             <tr height="35">
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_4;?>> 4. วันที่คุ้มครอง</td>
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_10;?>> 10. ประเภทการใช้รถ</td>
             </tr>
             <tr height="35">
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_5;?>> 5. จำนวนเงินคุ้มครอง</td>
              <td colspan="2">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_11;?>> 11. อื่นๆ(โปรดระบุ)</td>
             </tr>
             <tr height="35">
              <td colspan="4">&nbsp;<input type="checkbox" disabled="disabled" <?echo $chkb_6;?>> 6. เบี้ยประกันภัย</td>
             </tr>
           </td>
         </tr>
         <tr>
