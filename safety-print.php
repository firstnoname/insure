...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td height="150" colspan="4" valign="top"><center><h4>บริษัท ประกันภัยคุ้มภัย จำกัด(มหาชน) สาขาเชียงราย</h4></center> 
<center><h4>559/37 หมู่ 10 ตำบลสันทราย อำเภอเมือง จังหวัดเชียงราย 57000</h4></center>
<center><h4 >โทร (053) 701000 Fax. 701001</h4></center>
...
<hr class='dotted' />
  ...
  <tr >
    <td width="3%">&nbsp;</td>
    <td colspan="2" align="center" valign="top">  <h5>คำขอเอาประกันภัยรถยนต์</h5></td>
    <td width="2%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="2" rowspan="16" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <td height="28" align="right">บริษัท</td>
        <td><strong>ประกันภัยคุ้มภัย</strong></td>
        <td align="right">เลขที่กธ. พรบ</td>
        <td width="23%"><strong><?=$rw['act_number'] ?></strong></td>
        <td width="28%">เลขสติ๊กเกอร์</td>
      </tr>
      <tr>
        <td height="27">&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="27" colspan="5" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tbody>
            <tr>
              <td width="2%" align="right"><input type="checkbox"/></td>
              <td width="14%">ประเภท1</td>
              <td width="3%" align="right"><input type="checkbox"/></td>
              <td width="13%">ประเภท2</td>
              <td width="4%" align="right"><input type="checkbox"/></td>
              <td width="13%">ประเภท3</td>
              <td width="4%" align="right"><input type="checkbox"/></td>
              <td width="11%">พรบ</td>
              <td width="4%">&nbsp;</td>
              <td width="15%">&nbsp;</td>
            ...
            <tr>
              ...
              <td>Dealer แถมประกัน</td>
              <td align="right"><input type="checkbox"/></td>
              <td>Dealer แถมพรบ</td>
              <td align="right"><input type="checkbox"/></td>
              <td>ลูกค้าซื้อประกัน</td>
              <td align="right"><input type="checkbox"/></td>
              <td>ลูกค้าชื้อ พรบ</td>
              <td align="right"><input type="checkbox"/></td>
              <td>ไฟแนนซ์แถมประกัน</td>
              <td align="right"><input type="checkbox"/></td>
              <td>ไฟแนนซ์แถมพรบ</td>
              </tr>
            <tr>
      ...
      <tr>
        <td height="27" align="right">ชื่อผู้เอาประกันภัย</td>
        <td colspan="3"><strong><?php echo  $rw['be'].''.$rw['cus_name'].' '.$rw['cus_surename'] ;?></strong></td>
        <td><?=$rw['Cus_IDNo'] ?></td>
      </tr>
      <tr>
        <td height="27" align="right">ที่อยู่ในกรมธรรม์</td>
        <td colspan="3"><strong><?=$rw['ADDR_VILLAGE'].' '.$rw['ADDR_ROOM_NO'].' หมู่ '.$rw['ADDR_GROUP_NO'].'อำเภอ'.$rw['AMPHUR_NAME'].'จังหวัด'.$rw['PROVINCE_NAME']  ?></strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="31" align="right">ที่อยู่ส่งเอกสาร</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="29" colspan="2" align="right">ชื่อ(สำหรับออกใบเสร็จ/ใบกำกับภาษี)</td>
        <td colspan="3"><strong><?php echo  $rw['be'].''.$rw['cus_name'].' '.$rw['cus_surename'] ;?></strong></td>
        </tr>
      <tr>
        <td height="31" colspan="2" align="right">ที่อยู่(สำหรับออกใบเสร็จ/ใบกำกับภาษี)</td>
        <td colspan="3"><strong><?=$rw['ADDR_VILLAGE'].' '.$rw['ADDR_ROOM_NO'].' หมู่ '.$rw['ADDR_GROUP_NO'].'อำเภอ'.$rw['AMPHUR_NAME'].'จังหวัด'.$rw['PROVINCE_NAME']  ?></strong></td>
        </tr>
      <tr>
        <td height="31">&nbsp;</td>
        <td>แบบระบุซื่อ คนที่1</td>
        <td colspan="2">&nbsp;</td>
        <td>วัน/เดือน/ปี</td>
      </tr>
      <tr>
        <td height="29">&nbsp;</td>
        <td>แบบระบุซื่อ คนที่2</td>
        <td colspan="2">&nbsp;</td>
        <td>วัน/เดือน/ปี</td>
      </tr>
      <tr>
        <td height="38" align="right">ผู้รับผลประโยชน์</td>
        <td colspan="3">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="37" align="right">&nbsp;</td>
        <td align="right">เริ่มคุ้มครอง</td>
        <td><strong><?=$rw['insure_startdate'] ?></strong></td>
        <td align="right">สิ้นสุดคุ้มครอง</td>
      ...
      <tr>
        <td height="34" colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tbody>
            <tr>
              <td width="15%" align="right">ประเภทรุ่น</td>
              <td width="17%"><strong><?=$rw['vehicle_model_type'] ?></strong></td>
              <td width="17%">ทะเบียนรถ</td>
              <td width="17%"><strong><?php
		 if($rw['customer_type']==1){
		    echo 'ป้ายแดง';}else{echo $rw['vehicle_regis'];} 
		?></strong></td>
              <td width="17%">ขนาดเครื่องยนต์(ซีซี)</td>
              <td width="17%">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"><strong><?=$rw ['vehicle_full_chassis'] ?></strong></td>
              <td>เลขเครื่องยนต์</td>
              <td colspan="2"><strong><?=$rw['vehicle_chassis'] ?></strong></td>
              </tr>
          </tbody>
        </table></td>
        </tr>
      ...
      <tr>
        <td height="36" align="right">ทุนประกันภัย</td>
      ...
      <tr>
        ...
        <td colspan="3"><table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tbody>
            <tr>
              <td width="21%" align="right">เบี้ยพรบ. </td>
              <td width="25%"><strong><?=number_format($rw['net_act'],2) ?></strong></td>
              <td width="20%" align="right">เบี้ยรวมพรบ.</td>
              <td width="34%"><strong><?=number_format($rw['net_price']+$rw['net_act'],2) ?></strong></td>
              </tr>
            </tbody>
        </table></td>
        </tr>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><center>สลักด้านหลัง</center></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1">
          <tbody>
            ...
            <tr>
              <td>ผู้จ่าย</td>
              <td colspan="3">บริษัทอีซูซุเชียงราย(2002)จำกัด </td>
              </tr>
            <tr>
              <td>เบี้ยรวมภาษี</td>
              <td><?=number_format($rw['net_price']-$rw['discount_insure'],2) ?></td>
              <td>ลูกค้าจ่าย</td>
              <td>ลูกค้า</td>
              </tr>
            <tr>
              <td>เบี้ยพรบ.</td>
              <td><?=number_format($rw['net_act']-$rw['discount_act'],2) ?></td>
              <td>ลูกค้าจ่าย</td>
              <td>&nbsp;</td>
              </tr>
            <tr>
