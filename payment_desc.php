...
<div class="profile-user-info profile-user-info-striped col-sm-12">
  	<div class="profile-info-row">
													<div class="profile-info-name">ยอดค้างชำระทั้งหมด</div>

													<div class="profile-info-value">
													 <div  class="col-md-5"><span class='bigger-175 blue' id="net_price" >
                                                     <?php
													      $sql_r="SELECT CASE WHEN insurance_sale.payment_arrears =0 then format(insurance_sale.net_price-sum(insurance_sale.insurance_tax+
...
FROM
insurance_sale WHERE
insurance_sale.Close_payment=0 AND insurance_sale.pay_type='ผ่อนชำระ' AND insurance_sale.cus_id=".$_GET['cus_id'];
$rs_r=mysql_query($sql_r);
$rw_r=mysql_fetch_array($rs_r);
echo $rw_r['total_remain'].' บาท';
													 ?>
                                                     </span>
													</div>
												   </div>
  ...
  <div class="profile-info-row">
													...
													<div class="profile-info-value">
													 <div class="col-md-5">
                                                      <select id="selregis"  data-placeholder="Choose a State..." >
...
JOIN insurance_sale
ON insurance_relationship_view.vehicle_id = insurance_sale.vehicle_id WHERE insurance_sale.Close_payment=0 AND insurance_sale.cus_id=".$_GET['cus_id'];
																	
																	$rs_type2=mysql_query($sql_tyle2);
																	while($row_type2=mysql_fetch_array($rs_type2)){
																		echo '<option value="', $row_type2['vehicle_id'], '">', $row_type2['vehicle_regis'],'</option>';
																	}
																?>
                                            ...
                                            <div class="profile-info-row">
													<div class="profile-info-name">ยอดที่ต้องการชำระ</div>
										...
										<div class="profile-info-row">
													...
													<div class="profile-info-value">
                                                     ...
                                                     <div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1"  onChange="getdate()" value="<?=date('d-m-Y') ?>" type="text" data-date-format="dd-mm-yyyy" />
                                      ...
                                      <div class="profile-info-row">
													<div class="profile-info-name">ชำระครั้งถัดไปวันที่</div>

													<div class="profile-info-value">
													 <div class=" col-md-5" >
                                                     <div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-2" value="<?php 
...
echo date_format($date,"d-m-Y");
                                             ...
                                             <div class="profile-info-row">
													...
													<div class="profile-info-value">
													 <div class="col-md-5" >
                                                     <textarea class="form-control limited" id="remark" maxlength="250"></textarea>
													</div>
												   </div>
											</div>
</div>
...
<script src="assets/js/fuelux/fuelux.tree.js"></script>
       ...
       <script src="assets/js/jquery.knob.js"></script>
		...
		<script src="assets/js/ace/elements.spinner.js"></script>
			...
			function getdate() {
					var tts = document.getElementById('id-date-picker-1').value.split('-');
					 tt=tts[1]+'/'+tts[0]+'/'+tts[2];
					 //alert(tt);
				...
				//alert(newdate);
					...
					document.getElementById('id-date-picker-2').value = someFormattedDate;
				}
...
//var selected = [];
   ...
   /*
		 ...
		 //if($(this).is(":checked"){
						...
						//s_v=$(v[0].join(":");
						arrNumber.push(key+":"+v[0]);
						arrvehicle.push(v[2]+":"+v[3]+":"+v[4]+":"+v[1]+":"+v[0]);
						key++;
		 //}
	               });
			         if(cal_price1==0){
						 alert('กรุณาระบุงวดที่ต้องการชำระ');
						 return false; 
					 }
 ...
 $.ajax({
        url: "savepayment.php",
        type: "post",
        data: {cus_id:cus_id,pay_date:pay_date,next_pay_date:next_pay_date,remark:remark,cal_price1:cal_price1,remain:remain,paynum:arrNumber,arrveh:arrvehicle} ,
