...
INNER JOIN insurance_type ON insurance_type.id = insurance_presale.attend_insurance_type WHERE insurance_presale.cus_id=$cus_id  and insurance_presale.vehicle_id=$ve_id";
						...
						$price_total=($rw['net_price']+$rw['attend_net_act'])+$rw['insurance_tax'];
						...
						<div class="page-header">
							 ...
							 <div class="row">
											...
											<div class="col-xs-12">
												...
												<div class="widget-box1">
													...
													<?php
													   require_once("Select_Campaing_before.php");
													?>
							...
							<div class="profile-user-info profile-user-info-striped col-sm-12">
										...
										<form class="form-horizontal">
												<div class="tabbable">
													<ul class="nav nav-tabs padding-16" id="tabvalue">
												...
												<div class="form-group">
															...
															<div class="space-10"></div>
 	                                                         <div class="form-group">
																	...
																	<div class="col-sm-9">
																			...
																			<input value="<?=$net_total?>" id="txt_no_trans" type="text"> บาท
																	</div>
															</div>
															<div class="form-group">
												  ...
												  <div class="form-group">
																	...
																	<div class="col-sm-9">
																			...
																			<input value="<?=$net_total?>" id="txt_no_che" type="text"> บาท
																	</div>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																	...
																	<div class="col-sm-9">
																			...
																			<input value="" id="txt_no_che" type="text" maxlength="10"> 
																	</div>
															</div>
															<div class="form-group">
															        <label class="col-sm-3 control-label no-padding-right">ธนาคาร</label>
...
<div class="form-group">
																	...
																	<div class="col-sm-9">
																			...
																			<input value="<?=$net_total?>" id="txt_no_credit" type="text"> บาท
																	</div>
															</div>
															<div class="form-group">
...
$('#save_payment').click(function(){
    ...
    // var selinsurance_price_total=findAndReplace($('#selinsurance_price_total').text(),",","");
     var selact_price=findAndReplace($('#selact_price').text(),",","");
	 var selnet_total=findAndReplace($('#net_price').text(),",","");
	 var tax=findAndReplace($('#seltax').val(),",","");
	 var discount_insure=$('#seldiscount').val();
	...
	if(parseFloat($('#selact').val()) <0){
	alert('กรุณาตรวจสอบยอดเงินในการชำระอีกครั้ง');
	return false;
    }
        ...
        url: url_link,
        type: "post",
        data: {cu_id:cu_id,ve_id:ve_id,id:id,discount_insure:discount_insure,discount_act:discount_act,discount_tax:discount_tax,service:service,action:0,seltype:seltype,selcampaign:selcampaign,selnet_total:selnet_total,selact_price:selact_price,car_type:car_type,vehicle_model:vehicle_model,tax:tax} ,
...
var tab_action =$('#tabvalue li').val();
//alert(tab_action);
if(parseFloat($('#selact').val()) <0){
	alert('กรุณาตรวจสอบยอดเงินในการชำระอีกครั้ง');
	return false;
...
if(tab_action==0){
	...
	//alert(nettotal);
	//alert(arrNumber);
	if(nettotal<parseFloat($('#selact').val())){
 ...
 //	var discount_insure=$('#seldiscount').val();
	...
	// var discount_tax =$('#seldiscount_tax').val();
	// var service=$('#selservice').val();
	 var seltax=findAndReplace(findAndReplace($('#seltax_price').text(),"บาท",""),",","");
    var seltype=$('#seltype option:selected').val();
	var selcampaign=$('#selcampaign').val();
 ...
 $.ajax({
        url: url_link,
        type: "post",
        data: {cu_id:cu_id,ve_id:ve_id,discount_insure:discount_insure,discount_act:discount_act,discount_tax:discount_tax,service:service,pay_type:pay_type,pay_amount:pay_amount,pay_baht:pay_baht,ac_number:ac_number,id:id,vehicle_code_id:vehicle_code_id,vehicle_model_id:vehicle_model_id,pay_date:pay_date,pay_by:pay_by,pay_number:pay_number,pay_bank:pay_bank,pay_branch_name:pay_branch_name,action:1,paynum:arrNumber,seltype:seltype,selcampaign:selcampaign,selnet_total:selnet_total,car_type:car_type,vehicle_model:vehicle_model,tax:tax} ,
        success: function (response) {
		    //alert(response); 
								       bootbox.dialog({
													message: "ระบบบันทึกข้อมูลเรียบร้อย!", 
...
var price_net=0;
	   ...
	   total_price=total_price+parseFloat($('#seltax').val());
	   //alert(parseFloat($('#seltax').val()));
				...
				$.each(json, function(index, value) {
					...
					// in the set of matched elements.
					 ...
					 $("#selcampaign").append('<option value="' + value.campaign_id + 
											'">' + value.campaign_description +' [' + addCommas(value.insurance_startfund)  +'-'+ addCommas(value.insurance_endfund)+']'+ value.company_name +'</option>');
				});
			}
		});
	});
