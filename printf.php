...
WHERE insurance_relationship_view.cusno='4000782' AND insurance_relationship_view.vehicle_id =161584";
  ...
  <tr>
    ...
    <td colspan="2" rowspan="16" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        ...
        <td><strong>104/299 หมู่ 2 </strong></td>
        <td>(<?=$rw['relates_type'] ?>)</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="37">&nbsp;</td>
        <td>ทุนประกัน</td>
        <td><strong><?=$rw['insurance_endfund'] ?></strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="34">&nbsp;</td>
        <td>เบี้ยสุทธิ</td>
        <td><strong><?=$rw['net_price'] ?></strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
