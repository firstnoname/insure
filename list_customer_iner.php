									...
									<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>									
												...
												<tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
													...
													<a class="{{data.info_class}}"  href="presale.php?cus_id={{data.cusno}}&vehicle_id={{data.vehicle_id}}&id={{data.id}}">
														<button class="btn btn-xs btn-{{data.info_button}}" >
																<i class="ace-icon fa fa-{{data.info_icon}}"></i>
															</button>
															</a>
															<a class="{{data.print_class}}"  href="print_deposit.php?id={{data.cusno}}&vehicle_id={{data.vehicle_id}}"  title="ออกใบรับฝาก">
													...
													<td><span class="label label-{{data.info}} arrowed-right arrowed-in"> {{data.track_last_status}}</span></td>
...
<![endif]-->
		...
		<script>
		      ...
		      getSearch('activityCrtl','getListActivity_inter.php',20);
		</script>
	</body>
</html>
