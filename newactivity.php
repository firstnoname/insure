							...
							<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close" style="">
								...
								<li class="dropdown-content ace-scroll" style="position: relative;"><div class="scroll-track" style="display: none;"><div class="scroll-bar"></div></div><div class="scroll-content" style="">
									<ul class="dropdown-menu dropdown-navbar">
										 	<li>
											<a href="listcustomeractivity.html">
												<div class="clearfix">
												...
												<div class="clearfix">
													<span class="pull-left">
														 <i class="ace-icon fa fa-bullhorn"></i>
															โทรติดตามลูกค้าล่วงหน้า 1 เดือน 
													</span>
													<span class="pull-right badge badge-info">12</span>
												</div>
											</a>
										...
										<li>
											<a href="listcustomeractivity.html">
												<div class="clearfix">
													<span class="pull-left">
														  <i class="ace-icon fa fa-bullhorn"></i>
														โทรติดตามลูกค้าล่วงหน้า 2 เดือน 
													</span>
													<span class="pull-right badge badge-success">88</span>
												</div>
											</a>
										...
										<li>
											<a href="listcustomeractivity.html">
												<div class="clearfix">
													<span class="pull-left">
													  <i class="ace-icon fa fa-bullhorn"></i>
														โทรติดตามลูกค้าล่วงหน้า 4 เดือน 
													</span>
													<span class="pull-right badge badge-info">+11</span>
												</div>
											</a>
										...
										<li>
											<a href="listcustomeractivity.html">
												<div class="clearfix">
													...
													<span class="pull-right badge badge-info">21</span>
												</div>
											</a>
										</li>
									</ul>
											...
											<a href="#" class="clearfix">
												...
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue">คุณxxx  xxxxxxxx</span>
														นัดหมายโทรติดตามลูกค้า
													</span>
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
								<li class="">
								<a href="#" onClick="javascript:location='listactivity.html' " class="dropdown-toggle">
									<i class="menu-icon fa fa-caret-right"></i>
									กิจกรรมโทรติดตามลูกค้า
								</a>
							...
							<li class="">
								<a href="#"  onClick="javascript:location='listactivitytrack.html' "  class="dropdown-toggle">
									<i class="menu-icon fa fa-caret-right"></i>
									กิจกรรมลูกค้าใหม่
								</a>
					...
					<li class="">
						<a href="widgets.html">
							...
							<span class="menu-text"> รายงานสรุป </span>
						</a>
...
<div class="col-xs-12 col-sm-9">
											...
											<!-- /section:elements.form.input-icon -->
                                                      ...
                                                      <div class="profile-info-row">
                                                        ...
                                                        <div class="profile-info-value"><div class="col-sm-9"> <textarea id="form-field-comment" style="width: 167px; height: 30px;"></textarea></div></div>
                                                      </div>
                                                      <div class="profile-info-row">
...
สวัสดีครับ/คะ ขออนุญาตเรียนสายคุณ...(ชื่อลูกค้า).... ผม/ดิฉันชื่อ...(ผู้โทร).......โทรมาจากบริษัทอีซูซุเชียงราย แยกศรีทรายมูล ขอรบกวนเวลาประมาณ 5 นาที เพื่อโทรแจ้งรายละเอียดประภัยของรถลูกค้า ไม่ทราบว่าคุณ คุณ...(ชื่อลูกค้า).... สะดวก (ไปข้อ 2 ) ไม่สะดวก (ไปข้อ 1.2 )"
													</div>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<br />
													 <select name="select" class="chosen-select form-control" id="select" data-placeholder="Choose a State...">
                                                              <option value=""> </option>
                                                              <option value="AL">รถเก๋งใช้ส่วนบุคคล</option>
                                                              <option value="AK">รถปิคอัพโดยสารใช้ส่วนบุคคล</option>
												...
												<h3 class="header smaller lighter green">ทุนประกัน  &nbsp; xx,xxx.00</h3>
												 
												
												<h3 class="header smaller lighter green">เบี้ยสุทธิ  &nbsp; &nbsp; xx,xxx.00</h3>
												 
												<h3 class="header smaller lighter green">อากร&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xx,xxx.00</h3>
											 
												<h3 class="header smaller lighter green">ภาษี&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xx,xxx.00</h3>
									 
												<h3 class="header smaller lighter green">เบี้ยรวม&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; xx,xxx.00</h3>
												<button class="btn btn-sm btn-primary">เลือกเคมเปญ</button>
