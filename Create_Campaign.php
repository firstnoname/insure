				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
                            ...
                            <li class="active"> <a href="Show_Campaign.php">แคมเปญ</a></li>
                             <li class="active"> <a href="Create_Campaign.php">เพิ่มแคมเปญ</a></li>
                        </ul><!-- /.breadcrumb -->
...
<?php
    ...
    if (isset($_POST['SAVE'])) {
        ...
        $db->insert('insurance_campaign_detail',$arr_data);
			...
			if($_FILES['campaign_detail_file']['size'] > 0)
			{
			$fileName = $_FILES['campaign_detail_file']['name'];
			$tmpName  = $_FILES['campaign_detail_file']['tmp_name'];
			$fileSize = $_FILES['campaign_detail_file']['size'];
			$fileType = $_FILES['campaign_detail_file']['type'];
			...
			$sql_id="select campaign_id from insurance_campaign_detail order by  campaign_id desc Limit 1";
			$rs_id=mysql_query($sql_id) or die('Error, query failed'); 
			$rw_id=mysql_fetch_array($rs_id);
			$last_id=$rw_id['campaign_id'];
		
			$query = "INSERT INTO insurance_upload (campaign_id,filename, size, type, content ) ".
								...
								<form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-4" >
											...
											<select name="company_id"  id="company_id" data-placeholder="Choose a State...">
                                                <?php
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="insurance_type_id" id="insurance_type_id" data-placeholder="Choose a State...">
                                                 <?php
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" id="form-field-2" placeholder="แคมเปญ (ผลิตภัณฑ์)" class="col-xs-10 col-sm-5" name="campaign_description"/>
                                        </div>
                                    </div>
					...
					<div class="form-group">
										...
										<div class="col-sm-4">
											<select name="selvehicle_code" id="selvehicle_code" data-placeholder="Choose a State..." style="width:80px">
                                                 <?php
													...
													foreach ($coms as $com):
												?>
                                                <option value="<?=$com['vehicle_code_id']?>"><?=$com['vehicle_code_id']?></option>
                                                <?php
			                                        endforeach
			                                    ?>
                                            </select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="campaign_car_age" >
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<!-- #section:elements.form.input-icon -->
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_startfund">

											</span>
                                          -
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_endfund">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_price_center">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_price_garage">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="act_price">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_tax">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="insurance_promo">
                                   ...
                                   <div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="act_com_promo">
									...
									<div class="form-group" style="display:none">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="campaign_discount">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="campaign_income">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												<input type="text" id="form-field-icon-2" name="campaign_act">
										...
										<div class="col-sm-9">
											...
											<span class="input-icon input-icon-right">
												 	<div class="input-daterange input-group">
																	<input type="text" class="input-sm form-control" id="startDate" name="startDate"  data-date-format="dd-mm-yyyy" value="<?=date('Y-m-d'); ?>" />  
																	<span class="input-group-addon">
																		<i class="fa fa-exchange"></i>
																	</span>

																	<input type="text" class="input-sm form-control" id="endDate" name="endDate" data-date-format="dd-mm-yyyy"  value="<?=date('Y').'-'.(date('m')+1).'-'.date('d'); ?>"  />
																</div>
										...
										<div class="col-sm-9">
										 ...
										 <div class="form-group">
															<div class="col-sm-5">
																...
																<input type="file" id="campaign_detail_file" name="campaign_detail_file">
															</div>
														</div>
                                    ...
                                    <input type="submit" class="btn btn-success" name="SAVE" value="บันทึก" onClick="return confirm('ทำการบันทึกข้อมูล')">
