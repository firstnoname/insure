									...
									<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th width="130px">วันที่ขอยุติติดตาม<a ng-click="sort_by('reject_date');"><i class="glyphicon glyphicon-sort"></i></a></th>
											...
											<tbody>									
												...
												<tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
													...
													<td class="hidden-480">
													<span class="label label-danger arrowed-right arrowed-in">{{data.track_last_status}}</span>
													</td>
...
<![endif]-->
		...
		<script>
		<?php
		   $url="getListActivity_reject.php?id=".$_GET['activity_id'];
		?>
