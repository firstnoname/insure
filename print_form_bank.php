...
insurance_sale.vehicle_code_id,
...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td height="64" colspan="4" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td height="118" colspan="4" valign="top"><center>
      <p><strong><?php echo  $rw['be'].''.$rw['cus_name'].' '.$rw['cus_surename'] ;?></strong></p>
      <p>
        
          <strong> 
              <?=$rw['ADDR_VILLAGE'].' '.$rw['ADDR_ROOM_NO'].' หมู่ '.$rw['ADDR_GROUP_NO'].' ต.'.$rw['DISTRICT_NAME'].' อ.'.$rw['AMPHUR_NAME'].' จ.'.$rw['PROVINCE_NAME'] ?>
              </strong></p>
      <p><?= date('d',strtotime($rw['insure_startdate'])) ?>-<?= $monthNames[date('m',strtotime($rw['insure_startdate']))] ?>-<?= date('Y',strtotime($rw['insure_startdate']))+543 ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <?= date('d',strtotime($rw['insure_enddate'])) ?>
        -
        <?= $monthNames[date('m',strtotime($rw['insure_enddate']))] ?>
        -
        <?= date('Y',strtotime($rw['insure_enddate']))+543 ?>
        </p>
    </center> </td>
  </tr>
  ...
  <tr >
    ...
    <td width="67%" valign="top">  <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h5></td>
    <td width="2%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td colspan="2" rowspan="16" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="1">
      ...
      <tr>
        <td height="28"> <strong><?=$rw['vehicle_code_id'] ?> </strong></td>
        <td><strong>
         <?=$rw['vehicle_brand'] ?>
        </strong></td>
        <td><strong>
        ...
        <td width="19%"><strong>
          <?=$rw['vehicle_full_chassis'] ?>
        </strong></td>
        <td width="23%"><strong><?=$rw['vehicle_model_type'] ?>
        </strong></td>
      </tr>
      <tr>
        <td height="27">&nbsp;</td>
      ...
      <tr>
        <td height="31"><strong>
          <strong><?=$rw['act_price'] ?></strong>
        </strong></td>
        <td>0.00</td>
        <td><strong><?=$rw['act_price'] ?></strong></td>
        <td><strong><?=$rw['insurance_tax'] ?></strong></td>
        <td><strong><?=$rw['net_act'] ?></strong></td>
      </tr>
      <tr>
        <td height="25">&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="31">&nbsp;</td>
        <td><?= date('d',strtotime($rw['create_date'])) ?>-<?= $monthNames[date('m',strtotime($rw['create_date']))] ?>-<?= date('Y',strtotime($rw['create_date']))+543 ?></td>
        <td>&nbsp;</td>
        <td><?= date('d',strtotime($rw['create_date'])) ?>-<?= $monthNames[date('m',strtotime($rw['create_date']))] ?>-<?= date('Y',strtotime($rw['create_date']))+543 ?></td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        <td height="30">&nbsp;</td>
        <td><?= date('d',strtotime($rw['insure_startdate'])) ?>
          -
            <?= $monthNames[date('m',strtotime($rw['insure_startdate']))] ?>
            -
            <?= date('Y',strtotime($rw['insure_startdate']))+543 ?></td>
        <td>&nbsp;</td>
        <td><?= date('d',strtotime($rw['insure_enddate'])) ?>
          -
            <?= $monthNames[date('m',strtotime($rw['insure_enddate']))] ?>
            -
            <?= date('Y',strtotime($rw['insure_enddate']))+543 ?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="33">&nbsp;</td>
